...
<%@ Register Src="~/UserControls/BootstrapPagination.ascx" TagName="Pagination" TagPrefix="Bootstrap" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <Bootstrap:Pagination ID="Header" runat="server" pageIndex="2" totalCount="100" pagesize="10" />
</asp:Content>
